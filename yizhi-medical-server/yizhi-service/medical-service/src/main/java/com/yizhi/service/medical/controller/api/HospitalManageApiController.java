package com.yizhi.service.medical.controller.api;
...
import com.yizhi.util.common.helper.HttpRequestHelper;
...
@Api(tags = "医院接口管理端Api")
@RestController
@RequestMapping("/api/medical/manage")
//@CrossOrigin
public class HospitalManageApiController {
