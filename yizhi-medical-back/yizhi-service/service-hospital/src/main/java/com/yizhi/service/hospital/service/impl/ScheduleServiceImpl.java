...
public class ScheduleServiceImpl extends
    ...
    public void save(Map<String, Object> paramMap) {
        ...
        Schedule scheduleExist = scheduleRepository.
                findSchedule(schedule.getHospitalCode(),schedule.getHospitalScheduleId());
        //判断
    ...
    public void delete(String hospitalCode, String hospitalScheduleId) {
        //根据医院编号和排班编号查询信息
        Schedule schedule = scheduleRepository.findSchedule(hospitalCode, hospitalScheduleId);
        if(schedule != null) {
    ...
    @Override
    public Map<String, Object> getBookingRule(long page, long limit, String hospitalCode, String departCode) {
        //1 根据医院编号 和 科室编号 查询
        ...
        //获取医院名称
        String hospitalName = hospitalService.getHospitalName(hospitalCode);
        //其他基础数据
...
//    @Override
//    public List<Schedule> findSchedule(String hospitalCode, String departCode, String workDate) {
//        //根据参数查询mongodb
//        List<Schedule> scheduleList =
//                scheduleRepository.findSchedule(hospitalCode,departCode,new DateTime(workDate).toDate());
...
//    //获取可预约的排班数据
//    @Override
//    public Map<String, Object> getBookingScheduleRule(int page, int limit, String hospitalCode, String departCode) {
//        Map<String,Object> result = new HashMap<>();
//        //获取预约规则
//        //根据医院编号获取预约规则
...
//        Map<String, String> baseMap = new HashMap<>();
//        //医院名称
//        baseMap.put("hospitalName", hospitalService.getHospitalName(hospitalCode));
//        //科室
...
//        }
//        //获取预约规则信息
//        Hospital hospital = hospitalService.findAllByHospitalCode(schedule.getHospitalCode());
//        if(hospital == null) {
//            throw new YizhiException(ResultCodeEnum.PARAM_ERROR);
//        }
//        BookingRule bookingRule = hospital.getBookingRule();
...
//        scheduleOrderVo.setHospitalName(hospitalService.getHospitalName(schedule.getHospitalCode()));
...
//        //设置医院名称
//        schedule.getParam().put("hospitalName",hospitalService.getHospitalName(schedule.getHospitalCode()));
//        //设置科室名称
