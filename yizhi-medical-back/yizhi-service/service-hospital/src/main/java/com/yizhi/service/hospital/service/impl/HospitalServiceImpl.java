...
public class HospitalServiceImpl implements HospitalService {
    ...
    public void save(Map<String, Object> paramMap) {
        ...
        Hospital hospitalExist = hospitalRepository.findAllByHospitalCode(hospitalCode);
    ...
    @Override
    public Hospital findAllByHospitalCode(String hospitalCode) {
        Hospital hospital = hospitalRepository.findAllByHospitalCode(hospitalCode);
        return hospital;
    }
    ...
    //更新医院上线状态
    @Override
    public void saveStatus(String id, Integer status) {
        //根据id查询医院信息
    ...
    //获取医院名称
    @Override
    public String getHospitalName(String hospitalCode) {
        Hospital hospital = hospitalRepository.findAllByHospitalCode(hospitalCode);
        if(hospital != null) {
    ...
    //根据医院名称查询
    @Override
    public List<Hospital> findAllByHospitalName(String hospitalName) {
    ...
    public Map<String, Object> item(String hospitalCode) {
        Map<String, Object> result = new HashMap<>();
        //医院详情
        Hospital hospital = this.putHospitalTypeString(this.findAllByHospitalCode(hospitalCode));
        result.put("hospital", hospital);
        //预约规则
        result.put("bookingRule", hospital.getBookingRule());
        //不需要重复返回
